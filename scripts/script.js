...
function iniOffCanvas(){
  ...
  let observerHeader2;
  let observerConfigHeader2 = {
    rootMargin: '-25px 0px 100000px 0px',
    threshold: 1  
  };

  function observerFnHeader2(entries) {
  ...
  observerHeader2 = new IntersectionObserver(observerFnHeader2, observerConfigHeader2);
  observerHeader2.observe(header2);
}
